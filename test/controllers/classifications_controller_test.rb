...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { category_id: @classification.category_id, value: @classification.value, video_id: @classification.video_id } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { category_id: @classification.category_id, value: @classification.value, video_id: @classification.video_id } }
